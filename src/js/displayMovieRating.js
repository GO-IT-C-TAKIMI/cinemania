  ...
  const stars = [
    {
      ...
      svg: `<svg width="24" height="24" class="star-icon-full">
                  <use class="full-star" href="/cinemania/svg/symbol-defs.svg#icon-star-outline"></use>
                </svg>`,
    },
    {
      name: 'halfStar',
      svg: `<svg width="24" height="24" class="star-icon-half">
                  <use href="/cinemania/svg/symbol-defs.svg#icon-star-half"></use>
                </svg>`,
    },
    {
      name: 'emptyStar',
      svg: `<svg width="24" height="24" class="star-icon-empty">
                  <use href="/cinemania/svg/symbol-defs.svg#icon-star-outline"></use>
                </svg>`,
    },
  ];
